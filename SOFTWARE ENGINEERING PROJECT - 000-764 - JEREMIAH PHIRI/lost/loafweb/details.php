                               ...
                               <h5>
                                ...
                                $call= mysqli_query($connection,"SELECT * FROM generalitems where ID= '$id'");
								 while($fetch=mysqli_fetch_array($call)){
									 ...
									 " ",
									  "<sup class='entitytitles'> </sup>"," ","<u><h4> POSTED BY:"," ",$fetch['entity'],"</h4></u>",
									  "<img class='imgenetity' src='assets/images/".$fetch['image']."' height='400px' width='370px'>",
									  " ",
									...
									"<hr />
									 ...
									 "<h3><center><a href='claims.php?ID={$fetch['ID']}'>"
